...
metadata = data.frame(
	...
	condition = c("NA", "NA", "NA", "NA", "NA", "NA", "treated10wk", "NA", "untreated", "NA"),
...
write.table(resSig2wk[order(resSig2wk$pval), ], file="MediaControl_10WkSigDifExp.tsv", quote=FALSE, sep="\t", row.names = FALSE )
write.table(resSig2wk[order(resSig2wk$foldChange, -resSig2wk$baseMean ), ], file="MediaControl_10WkSigMostDownReg.tsv", quote=FALSE, sep="\t", row.names = FALSE )
write.table(resSig2wk[order(-resSig2wk$foldChange, -resSig2wk$baseMean ), ], file="MediaControl_10WkSigMostUpReg.tsv", quote=FALSE, sep="\t", row.names = FALSE )
