...
write.table(resSig2wk[order(resSig2wk$pval), ], file="MediaControl_10WkSigDifExp.tsv", quote=FALSE, sep="\t" )
write.table(resSig2wk[order(resSig2wk$foldChange, -resSig2wk$baseMean ), ], file="MediaControl_10WkSigMostDownReg.tsv", quote=FALSE, sep="\t" )
write.table(resSig2wk[order(-resSig2wk$foldChange, -resSig2wk$baseMean ), ], file="MediaControl_10WkSigMostUpReg.tsv", quote=FALSE, sep="\t" )
